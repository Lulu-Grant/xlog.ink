# xlog.ink documentation

## Current (use these)

| Doc | Topic |
|---|---|
| [V2-DESIGN.md](./V2-DESIGN.md) | Product / architecture |
| [PAY-RUNBOOK.md](./PAY-RUNBOOK.md) | Payment operations |
| [PAY-CREDITS-NEXT-DEV.md](./PAY-CREDITS-NEXT-DEV.md) | Pay/credits hardening (prior) |
...
| [AUDIT-7-NEXT-DEV.md](./AUDIT-7-NEXT-DEV.md) | Remediation plan for AUDIT-7 (mostly closed) |
| [config.example.php](./config.example.php) | Config template |
| [nginx-v2-snippet.conf](./nginx-v2-snippet.conf) | Nginx hardening (split CSP) |
